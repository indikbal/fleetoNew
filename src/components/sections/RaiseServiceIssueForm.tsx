...
export default function RaiseServiceIssueForm() {
    ...
    return (
      ...
      >
        ...
        <p className="text-sm text-gray-400 max-w-sm mx-auto" style={{ fontFamily: fonts.body }}>
          Your service issue has been raised. Our support team will review it and contact you soon.
        </p>
      </motion.div>
    );
  }
  ...
  return (
    <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
      ...
      >
        {loading ? "Submitting..." : "Raise Service Issue"}
