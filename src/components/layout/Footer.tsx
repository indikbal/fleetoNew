...
const columns = [
  {
    title: "Our Products",
    links: ["Aayan", "Jaguar", "Magnum", "Udaan", "Vihaan", "Wolf"],
  },
  {
    title: "Quick Links",
    links: ["Home", "About Us", "Support", "Contact Us", "Blog"],
  },
  {
    title: "About us",
    links: ["Privacy Policy", "Refund Policy", "Term & Conditions", "Book a Test Ride", "Resources"],
  },
  {
    title: "Support",
    links: ["Faqs", "Contact Us", "Retails Partnership", "Sitemap"],
  },
];
